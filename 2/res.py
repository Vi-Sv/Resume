...
story.append(Paragraph("ФИО", style_name))
...
story.append(Paragraph("<b>Локация:</b> Саратов, Россия (Удаленная работа / Гибрид / Релокация)<br/><b>Контакты:</b> [Номер телефона / Telegram] | [Почта] | [GitHub]", style_contacts))
...
story.append(Paragraph("Вооруженные Силы РФ", style_h2))
...
story.append(Paragraph("<b>Ключевые обязанности и навыки:</b>", style_body))
story.append(Paragraph("• <b>Информационная безопасность:</b> Работа со строгими регламентами защиты информации, администрирование закрытых каналов связи и обеспечение конфиденциальности передаваемых потоков данных.", style_bullet))
story.append(Paragraph("• <b>Отказоустойчивость и регламенты:</b> Эксплуатация аппаратных комплексов в условиях жестких нормативных требований, выполнение оперативных задач при строгом соблюдении протоколов безопасности.", style_bullet))
