...
job_2.append(Paragraph("• <b>Снижение операционных рисков:</b> Проводил регулярный аудит документации на соответствие требованиям строительного контроля, своевременно выявляя и устраняя расхождения в отчетности.", style_bullet))
...
story.append(Paragraph("<b>Период:</b> 2021 г. — 2022 г.", style_body))
