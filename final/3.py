...
def create_resume(output_filename="resume.pdf"):
    ...
    story.append(Paragraph("<b>Развернул изолированную девелоперскую среду для симуляции классического ELT/ETL | (Август 2026)</b>", body_style))
    story.append(Paragraph("<b>Стек:</b> Python (Pandas), PostgreSQL, Power BI, DBeaver, Jupyter Notebooks, VS Code", body_style))
    story.append(Paragraph("• На Python сгенерировал синтетический массив транзакций с аномалиями для тестирования отказоустойчивости.", bullet_style))
